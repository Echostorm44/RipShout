...
using static TagLib.Mpeg4.AppleDataBox;
...
public partial class App : Application
{
	...
	private async void OnExit(object sender, ExitEventArgs e)
	{
		...
		// find all files older than 10 days ago && clean them up
		var oldFiles = Directory.GetFiles(logFolder).Where(f => File.GetCreationTime(f) < DateTime.Now.AddDays(-10));
